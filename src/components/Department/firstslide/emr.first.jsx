...
function App() {
  ...
  useEffect(() => {
    axios
      .get('http://localhost:8082/emergency') // Make sure your API endpoint is correct and accessible
      .then(response => {
  ...
  return (
    <div className="bg-indigo-100 py-24 sm:py-32 shadow-md">
      <div className="mx-auto grid max-w-7xl gap-x-8 gap-y-20 space-x-4  px-6 lg:px-8 xl:grid-cols-3">
